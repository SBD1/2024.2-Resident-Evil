...
INSERT INTO arma(id_item,dano, nivel, chanceerro, chancecritico, maxmuni)
VALUES
...
INSERT INTO npc(identidade, nome, tipo)
VALUES
    (1, 'Mercador', 'vendedor'),
    (2, 'Ganado', 'zumbi'),
...
VALUES
    ...
    ("Verdugo",3,0,"duplo",3,"castelo","Mate o Verdugo e recupere a chave da câmara"),
    ("Salazar",4,0,"assassinato",1,"castelo","Mate Salazar"),

    ("Antigos Aliados",5,0,"assassinato",1,"ilha","Derrote Krauser"),
    ("Controle",5,0,"duplo",3,"ilha","Mate o regenerator e recupere a o cartão de acesso à sala de controle"),
...
VALUES
    ...
    (3,"Chave da Sala de Controle","Chave para a Sala de Controle na Ilha",0,0,"chave"),
